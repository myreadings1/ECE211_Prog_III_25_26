...
- Quiz1: Date (Oct 7th, 2025): covers all material up to this date.
   - Example1: Write a C code program to accept user input, like integer, and print a shape like this [picture](https://drive.google.com/file/d/16PQdUGh1IYMC55qDvf2i1IlcCJ_gAt-M/view?usp=drive_link).
   - Example2: Write a C code program to count number of ones a variable x, where x is defined as int x.
- Quiz2
- Midterm
- Quiz3
- Quiz4
