...
- HW4:
   - Due on (Oct 28th,2025): Write a code program that user C structures to hold students data (10 students). Then, use functions to write C structures to a C file. You should try the following: (1) Try both types of file: text and binary, (2) Create C structures at run time using dynamic memory allocation, (3) Use C files, and (4) Your program should student data from users input. 
